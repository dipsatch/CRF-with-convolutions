    ...
    for i in range(num_epochs):
        ...
        for i_batch, sample in enumerate(train_loader):
            ...
            if step % print_iter == 0:
                ...
                letter_acc.append(accuracy[0])
                word_acc.append(accuracy[1])
        ...
        del train, test
    graph.get_graph(letter_acc,prin_ep,"Letter accuracy")
    graph.get_graph(word_acc,prin_ep,"Word accuracy")